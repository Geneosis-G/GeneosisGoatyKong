class GoatyKongTheme extends GGMutator;

var SoundCue kongTheme;
...
function MusicManager()
{
	...
	{
		mAC = CreateAudioComponent( kongTheme, true );
	}
...
DefaultProperties
{
	kongTheme=SoundCue'GoatyKongSounds.GoatyKongThemeCue'
}